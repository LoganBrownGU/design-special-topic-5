...
module flue_taper_ext() {
    ...
    translate([0, 0, flue_taper_into_slit + flue_floor_thickness - clip_depth]) clip_inner(clip_depth, slide_mount_width, slide_mount_width);
}
    ...
    difference() {
        ...
        hull () {
            ...
            translate([-flue_slit_length / 2, -slide_mount_width / 2 + flue_slit_offset, flue_taper_into_slit])
                linear_extrude(flue_floor_thickness + clip_depth * 3)  square([flue_slit_length, flue_slit_depth]);
        }
    }
}
